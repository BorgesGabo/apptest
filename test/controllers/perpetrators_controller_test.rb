...
class PerpetratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perpetrator" do
    assert_difference('Perpetrator.count') do
      post perpetrators_url, params: { perpetrator: { age: @perpetrator.age, gender: @perpetrator.gender, live_together: @perpetrator.live_together, relationship: @perpetrator.relationship } }
    end
  ...
  test "should update perpetrator" do
    patch perpetrator_url(@perpetrator), params: { perpetrator: { age: @perpetrator.age, gender: @perpetrator.gender, live_together: @perpetrator.live_together, relationship: @perpetrator.relationship } }
